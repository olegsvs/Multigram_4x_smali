...
.method public constructor <init>(Landroid/content/Context;Lorg/telegram/tgnet/TLRPC$ChatInvite;Ljava/lang/String;Lorg/telegram/ui/ActionBar/BaseFragment;)V
    ...
    invoke-virtual {v12, v2}, Landroid/widget/LinearLayout;->setClickable(Z)V
    ...
    invoke-virtual {v0, v12}, Lorg/telegram/ui/Components/JoinGroupAlert;->setCustomView(Landroid/view/View;)V

    .line 70
    const/4 v15, 0x0

    .line 73
    .local v15, "photo":Lorg/telegram/tgnet/TLRPC$FileLocation;
    move-object/from16 v0, p2
    ...
    iget-object v15, v2, Lorg/telegram/tgnet/TLRPC$ChatPhoto;->photo_small:Lorg/telegram/tgnet/TLRPC$FileLocation;
    ...
    iget v14, v2, Lorg/telegram/tgnet/TLRPC$Chat;->participants_count:I

    .line 90
    .local v14, "participants_count":I
    :goto_0
    ...
    invoke-virtual {v10, v15, v2, v9}, Lorg/telegram/ui/Components/BackupImageView;->setImage(Lorg/telegram/tgnet/TLObject;Ljava/lang/String;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 108
    .restart local v18    # "textView":Landroid/widget/TextView;
    const/4 v2, 0x1
    ...
    invoke-static {v11, v2}, Lorg/telegram/messenger/AndroidUtilities;->setDarkColor(II)I
    ...
    invoke-static {v2, v14}, Lorg/telegram/messenger/LocaleController;->formatPluralString(Ljava/lang/String;I)Ljava/lang/String;
    ...
    .line 122
    new-instance v13, Lorg/telegram/ui/Components/RecyclerListView;

    move-object/from16 v0, p1

    invoke-direct {v13, v0}, Lorg/telegram/ui/Components/RecyclerListView;-><init>(Landroid/content/Context;)V

    .line 123
    .local v13, "listView":Lorg/telegram/ui/Components/RecyclerListView;
    const/4 v2, 0x0
    ...
    invoke-virtual {v13, v2, v3, v4, v5}, Lorg/telegram/ui/Components/RecyclerListView;->setPadding(IIII)V

    .line 124
    const/4 v2, 0x0

    invoke-virtual {v13, v2}, Lorg/telegram/ui/Components/RecyclerListView;->setNestedScrollingEnabled(Z)V

    .line 125
    const/4 v2, 0x0

    invoke-virtual {v13, v2}, Lorg/telegram/ui/Components/RecyclerListView;->setClipToPadding(Z)V
    ...
    invoke-virtual {v13, v2}, Lorg/telegram/ui/Components/RecyclerListView;->setLayoutManager(Lorg/telegram/messenger/support/widget/RecyclerView$LayoutManager;)V

    .line 127
    const/4 v2, 0x0

    invoke-virtual {v13, v2}, Lorg/telegram/ui/Components/RecyclerListView;->setHorizontalScrollBarEnabled(Z)V

    .line 128
    const/4 v2, 0x0

    invoke-virtual {v13, v2}, Lorg/telegram/ui/Components/RecyclerListView;->setVerticalScrollBarEnabled(Z)V
    ...
    invoke-virtual {v13, v2}, Lorg/telegram/ui/Components/RecyclerListView;->setAdapter(Lorg/telegram/messenger/support/widget/RecyclerView$Adapter;)V
    ...
    invoke-virtual {v13, v2}, Lorg/telegram/ui/Components/RecyclerListView;->setGlowColor(I)V
    ...
    .line 134
    .end local v13    # "listView":Lorg/telegram/ui/Components/RecyclerListView;
    :cond_4
    ...
    .line 138
    new-instance v16, Lorg/telegram/ui/Components/PickerBottomLayout;
    ...
    .line 139
    .local v16, "pickerBottomLayout":Lorg/telegram/ui/Components/PickerBottomLayout;
    const/4 v2, -0x1
    ...
    invoke-virtual {v0, v2}, Lorg/telegram/ui/Components/PickerBottomLayout;->setBackgroundColor(I)V

    .line 157
    sget v2, Lorg/telegram/ui/ActionBar/Theme;->chatAttachTextColor:I
    ...
    sget v3, Lorg/telegram/ui/ActionBar/Theme;->chatAttachTextColor:I

    const/16 v4, -0x40

    invoke-static {v3, v4}, Lorg/telegram/messenger/AndroidUtilities;->setDarkColor(II)I
    ...
    .end local v14    # "participants_count":I
    .end local v16    # "pickerBottomLayout":Lorg/telegram/ui/Components/PickerBottomLayout;
    ...
    iget v14, v0, Lorg/telegram/tgnet/TLRPC$ChatInvite;->participants_count:I

    .restart local v14    # "participants_count":I
    goto/16 :goto_0
